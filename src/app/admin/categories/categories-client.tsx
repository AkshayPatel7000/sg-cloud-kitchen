...
function CategoryForm({ currentCategory, onSave, closeDialog }: { currentCategory?: Category | null, onSave: (data: CategoryFormValues, id?: string) => void, closeDialog: () => void }) {
        ...
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>Fill in the details for the menu category.</DialogDescription>
            </DialogHeader>
            <CategoryForm currentCategory={currentCategory} onSave={handleSave} closeDialog={() => setIsDialogOpen(false)} />
          </DialogContent>
        </Dialog>
      </div>
      <Card>
                  ...
                  <TableCell>
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => { setCurrentCategory(category); setIsDialogOpen(true); }}><Edit className="mr-2 h-4 w-4"/>Edit</DropdownMenuItem>
                         <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader><AlertDialogTitle>Are you sure?</AlertDialogTitle><AlertDialogDescription>This will permanently delete the category.</AlertDialogDescription></AlertDialogHeader>

...
export const VegNonVegIcon = ({ isVeg, className }: { isVeg: boolean, className?: string }) => {
  ...
  return (
    <div className={cn("w-4 h-4 border p-0.5 flex items-center justify-center", borderClass, className)} title={isVeg ? 'Vegetarian' : 'Non-Vegetarian'}>
